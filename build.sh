...
sed -i "s/test.mosquitto.org/localhost/g" ./build/linux-amd64/thing-publisher.json
...
sed -i "s/test.mosquitto.org/localhost/g" ./build/linux-arm/thing-publisher.json
